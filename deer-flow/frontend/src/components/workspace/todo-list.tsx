...
export function TodoList({
  ...
  return (
    <div
      className={cn(
        "flex h-fit w-full origin-bottom translate-y-4 flex-col overflow-hidden rounded-t-xl border border-b-0 border-white/[0.06] bg-white/[0.03] backdrop-blur-xl transition-all duration-200 ease-out",
